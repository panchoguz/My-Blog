...
Dadas las 5 opciones que nos muestra el resultado, para efectos de este artículo, nos quedaremos con la primera *"GDP per capita, PPP (constant 2017 international $)"*.
...
g1 <- ggplot(df, aes(year, gdp_pc, color=country)) +
  ...
  theme(plot.title = element_text(size = rel(1.05)),
        plot.subtitle = element_text(size = rel(.85), margin=margin(0,0,20,0)),
